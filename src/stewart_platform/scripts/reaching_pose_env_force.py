...
register(
        id='StewartPose-v0',
        entry_point='reaching_pose_env_force:PoseSetEnv',
...
class PoseSetEnv(stewart_env_force.StewartEnv):
    def __init__(self):
        ...
        self.action_space =  spaces.Box( low   = np.array([ self.f1_range[0], self.f2_range[0], self.f3_range[0], self.f4_range[0], self.f5_range[0], self.f6_range[0]]),
                                         high  = np.array([ self.f1_range[1], self.f2_range[1], self.f3_range[1], self.f4_range[1], self.f5_range[1], self.f6_range[1]]), 
                                         dtype = np.float32)
    ...
    def get_params(self):
        ...
        # get force value ranges - Action space range
        self.f1_range = rospy.get_param("/stewart/f1_range_value")
        self.f2_range = rospy.get_param("/stewart/f2_range_value")
        self.f3_range = rospy.get_param("/stewart/f3_range_value")
        self.f4_range = rospy.get_param("/stewart/f4_range_value")
        self.f5_range = rospy.get_param("/stewart/f5_range_value")
        self.f6_range = rospy.get_param("/stewart/f6_range_value")
